...
public class Drivetrain extends SubsystemBase {
    ...
    private final MotorControllerGroup m_leftMotors = new MotorControllerGroup(leftFrontMotor, leftMidMotor,
            leftBackMotor);

    private final MotorControllerGroup m_rightMotors = new MotorControllerGroup(rightFrontMotor, rightMidMotor,
            rightBackMotor);
